...
validated `conformance/v0.4.0-rc.3.yml` claim. Canonical view records are
...
- `cargo package --allow-dirty --list`: package contents exclude local
  ...
  exact `mdbase = 0.4.0-rc.3` crate to be available from the release registry.

Evidence last refreshed: 2026-08-08 on Linux x86_64 with Rust 1.94.0.
